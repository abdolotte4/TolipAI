...
### PRIORITY 1: HOMEPAGE COMPLETE REWRITE (Do First)
...
- "Virtual Assistants for Real Estate" section (or completely reframe as "CRM Administration Support")
- "Data Enrichment & Contact Management" section
- "Managed Outreach Operations" section
- "High-Propensity Data Segments" section (or reframe as "Property Intelligence Segments" with ZERO mention of contact enrichment)
- "Client Performance Analytics" section with ROI claims and conversion funnels
...
**ADD:**
- "About TolipAI" section near top with clear SaaS positioning
...
### PRIORITY 2: FEATURE DESCRIPTIONS
...
### PRIORITY 3: TESTIMONIALS & CASE STUDIES
...
**Replace with:**
> "TolipAI's CRM platform transformed our operational workflow completely. Their software infrastructure delivered organized pipeline management and workflow automation that we had never experienced before. Our team efficiency increased by 200% within the first quarter."
...
### PRIORITY 4: PRICING PAGE ENHANCEMENTS

**Add visible footer to pricing page with:**
...
**If there is a subscribe/checkout modal** (I did not see one in the crawl), ensure:
- Header says "CRM & Workflow Automation Plans" (NOT "Verified Property Data Contacts")
- Package descriptions use: CRM infrastructure, Property intelligence tools, Workflow automation, Managed CRM operations, AI-assisted research tools, Property analysis capabilities, Team support services
- NO mention of: "High-intent property data records," "Data records delivered," "Verified property contacts"

### PRIORITY 5: SMS CONSENT (Preserve)
...
Ensure Privacy Policy and Terms links are directly visible next to consent language.
...
- [ ] Rewrite homepage hero to emphasize "SaaS CRM Platform"
- [ ] Remove AI voice agent / dialer features entirely from public site
- [ ] Remove "Data Enrichment" and "Managed Outreach" service sections
- [ ] Remove or reframe "Virtual Assistant" section as "CRM Support"
- [ ] Rewrite all testimonials to focus on software, not data/outreach
- [ ] Remove ROI claims, deal counts, and transaction-focused metrics
- [ ] Add "About TolipAI" section with clear SaaS positioning
- [ ] Add "Trust & Compliance" section with Wyoming LLC info
- [ ] Add visible footer on ALL pages with legal name, address, phone, email, and all policy links
- [ ] Remove "Real Estate Investment & Wholesaling" from parent company description
- [ ] Remove "B2B Marketing & Data Analytics" from parent company description
- [ ] Replace phone number capture with Calendly scheduling
- [ ] Ensure pricing page has clear SaaS plan descriptions
- [ ] Verify subscribe/checkout modal uses "CRM Plans" not "Data Contacts"
- [ ] Keep all TCPA/SMS consent language intact
- [ ] Keep all legal pages (Terms, Privacy, AUP, Cookie) as-is
- [ ] Ensure compliance page is accessible and loads correctly
...
|---|---|---|
| Homepage (`/`) | Complete rewrite of all service descriptions, remove dialer/AI voice, add Trust section | P0 |
| Pricing (`/pricing`) | Add footer with legal info, verify no "data contacts" language | P1 |
| Mission/Vision (`/mission-vision-values`) | Minor bio text cleanup | P2 |
| Compliance (`/compliance`) | Verify accessibility, keep content | P1 |
| Acceptable Use (`/acceptable-use`) | Keep as-is | — |
| Cookie Policy (`/cookie-policy`) | Keep as-is | — |
