  ...
  return (
    <div className="space-y-6 pb-20 max-w-2xl">
          ...
          {configured && (
            <div className="pt-1 border-t border-white/5">
              <button
                ...
                onClick={() => {
                  if (confirm("Remove Propwire credentials for this campaign?")) {
      ...
      <Card className="rounded-2xl border-white/5 bg-card/50 p-5">
        <h3 className="text-xs font-semibold uppercase text-muted-foreground tracking-wider mb-3">What Propwire powers</h3>
        <ul className="space-y-2 text-sm text-muted-foreground">
          {[
            "Nearby cash buyer / investor list around a subject property",
            "Comparable sales (comps) for quick ARV analysis",
            "Full property history — ownership chain, prior sales, mortgages",
