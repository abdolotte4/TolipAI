    ...
    <div className="space-y-6 pb-20 max-w-2xl">
      <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }}>
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          <a href="https://genesis.propelio.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors">
        ...
        <Card className="rounded-2xl border-white/5 bg-card p-6 space-y-5">
          ...
          {configured && (
            <div className="pt-1 border-t border-white/5">
              <button className="text-xs text-destructive/70 hover:text-destructive flex items-center gap-1.5 mt-3" onClick={() => { if (confirm("Remove Propelio credentials for this campaign?")) saveMutation.mutate({ email: "", password: "" }); }}>
