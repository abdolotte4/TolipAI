...
function SuperAdminRoute({ children }: { children: React.ReactNode }) {
  ...
  if (isLoading) return <div className="min-h-screen bg-background flex items-center justify-center"><div className="animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-primary" /></div>;
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/admin/health"><AppLayout><SuperAdminRoute><SystemHealth /></SuperAdminRoute></AppLayout></Route>
