...
export function AppLayout({ children }: AppLayoutProps) {
  ...
  const mainNavItems = isSuperAdmin ? [{ label: "Campaigns", href: "/campaigns", icon: Globe }, { label: "All Leads", href: "/leads", icon: Users, badge: newLeadsCount }, { label: "Pipeline", href: "/pipeline", icon: Columns }, { label: "Analytics", href: "/analytics", icon: BarChart2 }, { label: "All Tasks", href: "/tasks", icon: CheckSquare, badge: pendingTasksCount }, { label: "Buyers List", href: "/buyers", icon: BookUser }, { label: "Cash Buyer DB", href: "/cash-buyers", icon: Database }, { label: "Distressed Lead Gen", href: "/lead-gen", icon: Zap }] : [{ label: "Dashboard", href: "/", icon: LayoutDashboard }, { label: "Leads", href: "/leads", icon: Users, badge: newLeadsCount }, { label: "Pipeline", href: "/pipeline", icon: Columns }, { label: "Analytics", href: "/analytics", icon: BarChart2 }, { label: "Tasks", href: "/tasks", icon: CheckSquare, badge: pendingTasksCount }, { label: "Buyers List", href: "/buyers", icon: BookUser }, { label: "Cash Buyer DB", href: "/cash-buyers", icon: Database }, { label: "Distressed Lead Gen", href: "/lead-gen", icon: Zap }];
