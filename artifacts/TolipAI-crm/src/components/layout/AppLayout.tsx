...
export function AppLayout({ children }: AppLayoutProps) {
  ...
  const adminNavItems = [{ label: "Team Users", href: "/admin/users", icon: Settings }, { label: "Submission Links", href: "/admin/links", icon: LinkIcon }, { label: "Email Sequences", href: "/admin/sequences", icon: Mail }, { label: "Waitlist", href: "/admin/waitlist", icon: Users2 }];
