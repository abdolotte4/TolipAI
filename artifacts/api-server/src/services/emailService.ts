  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #1a1a1a;">
      ...
      <div style="background: #f9fafb; padding: 32px; border-radius: 0 0 12px 12px; border: 1px solid #e5e7eb; border-top: none;">
        ...
        <a href="https://tolipai.com/crm/leads/${opts.leadId}"
  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #1a1a1a;">
      ...
      <div style="background: #f9fafb; padding: 32px; border-radius: 0 0 12px 12px; border: 1px solid #e5e7eb; border-top: none;">
        ...
        ${opts.leadId ? `<a href="https://tolipai.com/crm/leads/${opts.leadId}" style="display: inline-block; background: #7367F0; color: white; padding: 14px 28px; border-radius: 8px; text-decoration: none; font-weight: 600;">View Lead</a>` : ""}
        <hr style="border: none; border-top: 1px solid #e5e7eb; margin: 32px 0 16px;" />
