# TolipAI Project Architecture

## Monorepo Structure
- `artifacts/` — runnable applications (api-server, TolipAI-crm, TolipAI-website, TolipAI-tools)
...
- `artifacts/TolipAI-crm` — React + Vite CRM frontend, port 3001
- `artifacts/TolipAI-website` — React + Vite marketing site, port 3000
- `artifacts/TolipAI-tools` — React + Vite tools dashboard, port 3002
